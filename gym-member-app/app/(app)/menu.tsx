...
const TILES: Tile[] = [
  ...
  { label: 'Member ID', icon: 'qr', route: '/id', gymOnly: true },
  { label: 'Visit history', icon: 'calendar', route: '/visits', gymOnly: true },
  { label: 'Membership', icon: 'medal', route: '/membership', gymOnly: true },
