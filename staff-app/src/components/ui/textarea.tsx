...
function Textarea({
  ...
  return (
    <TextInput
      ...
      // NOTE (MuscleX): `placeholderClassName` is a NativeWind prop that RNR's
      // uniwind build ships by mistake; uniwind calls it
      // `placeholderTextColorClassName`. The placeholder colour is already
      // carried by the `placeholder:` class in className, matching Input.
      multiline={multiline}
