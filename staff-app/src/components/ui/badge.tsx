  ...
  ),
  {
    variants: {
      variant: {
        ...
        // NOTE (MuscleX): `success` and `warning` are not stock shadcn/RNR.
        // The product needs them: without a success variant, "Active" renders
        // in the same colour as "Overdue", which is the exact distinction a
        // staff member scans a member list for.
        success: cn(
