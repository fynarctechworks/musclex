    ...
    <DropdownMenuPrimitive.Portal hostName={portalHost}>
      <FullWindowOverlay>
        <DropdownMenuPrimitive.Overlay
          // NOTE (MuscleX): RNR ships this without a type argument. RN 0.86
          // infers AbsoluteFillStyle from the `native` branch, which the `web`
          // branch's StyleProp<ViewStyle> (it admits false | '' | arrays) does
          // not satisfy. Naming the type is what reconciles the two branches.
