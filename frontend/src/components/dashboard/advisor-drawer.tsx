...
import { AiComingSoon, useAiStatus } from "@/features/ai";
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {!aiAvailable ? (
              /* No composer at all: a box that takes a question and answers
                 "not yet" is worse than one that never asked for it. */
              <div className="flex-1 overflow-y-auto p-4">
                <AiComingSoon className="h-full" />
              </div>
            ) : (
              <>
