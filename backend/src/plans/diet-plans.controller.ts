...
import { AssignDietPlanDto, CreateDietPlanDto, UpdateDietPlanDto } from './dto';

@Controller('api/v1/diet-plans')
@UseGuards(JwtAuthGuard, RolesGuard, PermissionsGuard)
export class DietPlansController {
  constructor(
    private readonly plans: DietPlansService,
  ...
  async create(@Body() dto: CreateDietPlanDto, @CurrentUser() user: JwtPayload) {
