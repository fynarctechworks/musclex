...
// TENANT_MODELS (the set of gym_id models) is imported at the top from the single
// source of truth shared with prisma.service.ts's $use middleware — never define a
// second copy here (a drift between two copies previously caused a leak).
