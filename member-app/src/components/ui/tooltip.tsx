// NOTE (MuscleX): taken from staff-app rather than the registry output.
// The @rnr registry emits the newer `render={<X />}` primitive API, but
// @rn-primitives/* here is pinned at 1.5.2, which takes `asChild`. staff-app
// already made that substitution against the same versions.
