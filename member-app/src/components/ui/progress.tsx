...
function NativeIndicator({ value, className }: IndicatorProps) {
  ...
  return (
    // NOTE (MuscleX): the registry emits the newer `render={...}` primitive API,
    // but @rn-primitives/progress is pinned at 1.5.2, which takes `asChild`.
    // Same substitution staff-app makes.
